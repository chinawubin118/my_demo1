package com.tuoyan.asynchttp.dialog;
...
public class ProgressHUD extends Dialog {
    ...
    private static boolean isProgressCancelable = true;

    public void setProgressCancelable(boolean cancelable) {
        isProgressCancelable = cancelable;
    }
    ...
    public static ProgressHUD show(Context context, CharSequence message, boolean indeterminate, boolean cancelable, OnCancelListener cancelListener) {
        ...
        isProgressCancelable = cancelable;
        dialog.setCancelable(isProgressCancelable);
