...
//                    try {
//                        if (null != photoViewAttacher && null != photoViewAttacher.getOnPhotoTapListener()) {
//                            photoViewAttacher.getOnPhotoTapListener().onOutsidePhotoTap();//实际调用的是一个抽象方法啊,造成崩溃....不知道谁这么写的
//                        }
//                    } catch (Exception e1) {
//                        e1.printStackTrace();
//                    }
